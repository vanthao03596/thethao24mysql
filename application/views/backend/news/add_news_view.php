...
$input_link = array('name' => 'link','type' => 'text','value' => ($link) ? $link : '',
    'maxlength' => '255','minlength' => '2','min' => 0,'class' => 'form-control');
    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title info-box-text">Thêm mới Tin tức</h3>
            </div><!-- /.box-header -->
            <!-- form start -->
            <div class="row">
            ...
            echo form_open(base_url().'index.php/backend/news/addNews', $attributes);
            ?>
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        echo form_dropdown('topic_id', $listNewsTopic, $topic_id, $attr);
                        ?>
                    </div>
